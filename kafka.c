...
PHP_MINIT_FUNCTION(kafka)
{
    ...
    REGISTER_LONG_CONSTANT("KAFKA_VERSION", rd_kafka_version(), CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("KAFKA_BUILD_VERSION", RD_KAFKA_VERSION, CONST_CS | CONST_PERSISTENT);
